...
func _ready():
	...
	Tooltipp_turrets = get_node("../Build_Menue/Build_HUD/Build_Bar/HBoxContainer/Turret")
...
func update_tower_preview():
	...
	var zu_teuer = get_node("../CanvasLayer/Control/Material").to_expensive(towerData[build_type]["cost"])
...
func verify_and_build():
	...
	if build_valid:
		...
		get_node("../CanvasLayer/Control/Material").buy_shit(towerData[build_type]["cost"])
