...
func _process(delta):
	...
	if(HP>75):
		self.play(Nation + ":" + which_sprites_to_play[0])
	elif (HP<=75 && HP>50):
		self.play(Nation + ":" + which_sprites_to_play[1])
	elif (HP<=50 && HP>25):
		self.play(Nation + ":" + which_sprites_to_play[2])
	elif (HP<=25 && HP>0):
		self.play(Nation + ":" + which_sprites_to_play[3])
	elif (HP<=0):
		self.play(Nation + ":" + which_sprites_to_play[4])
